...
class ValidSudokuPage extends Component {
	state = {
        showTests: false
	};
    ...
    showTests = () => {
        ...
        <div>
            ...
            <p>This will require all of your might to stick 
                with this test first mentality, unless, of course, you are a TDD veteran.
                Even after my realization that TDD is the one true way to happiness,
                I find myself heading down the distant trails of untested possibility.
                There are tons of other things that we need to do before we can 
            ...
            <Gist id="3820928f3d55cb5acb8489e0bbb20030" />
        </div>);
    }
    ...
    showCode = () => {
        ...
        <div>
            ...
            <p>We write our tests one at a time and then make them pass as we go. If you like to play 
                ...
                if you're curious!</p>
            <Gist id="c6ba14296e3aa0576170000a63af7abe" />
        </div>);
    }
